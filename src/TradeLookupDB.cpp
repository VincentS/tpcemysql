...
#elif HANA_ODBC
		osTLF1_2 << "SELECT se_amt, TO_VARCHAR(se_cash_due_date, 'YYYY-MM-DD'), se_cash_type FROM settlement WHERE se_t_id = " <<
#elif PGSQL_ODBC
...
#elif HANA_ODBC
			osTLF1_3 << "SELECT ct_amt, TO_VARCHAR(ct_dts, 'YYYY-MM-DD HH24:MI:SS.FF6'), ct_name FROM cash_transaction WHERE ct_t_id = " <<
#elif PGSQL_ODBC
...
#elif HANA_ODBC
		osTLF1_4 << "SELECT TO_VARCHAR(th_dts, 'YYYY-MM-DD HH24:MI:SS.FF6'), th_st_id FROM trade_history WHERE th_t_id = " <<
	    pIn->trade_id[i] << " ORDER BY th_dts LIMIT 3";
#elif PGSQL_ODBC
...
#elif HANA_ODBC
		osTLF2_2 << "SELECT se_amt, TO_VARCHAR(se_cash_due_date, 'YYYY-MM-DD'), se_cash_type FROM settlement WHERE se_t_id = " <<
#elif PGSQL_ODBC
...
#elif HANA_ODBC
			osTLF2_3 << "SELECT ct_amt, TO_VARCHAR(ct_dts, 'YYYY-MM-DD HH24:MI:SS.FF6'), ct_name FROM cash_transaction WHERE ct_t_id = " <<
#elif PGSQL_ODBC
...
#elif HANA_ODBC
		osTLF2_4 << "SELECT TO_VARCHAR(th_dts, 'YYYY-MM-DD HH24:MI:SS.FF6'), th_st_id FROM trade_history WHERE th_t_id = " <<
	    pOut->trade_info[i].trade_id << " ORDER BY th_dts LIMIT 3";
#elif PGSQL_ODBC
										 ...
										 TTradeLookupFrame3Output *pOut)
{
	...
	pIn->max_trades;
#elif HANA_ODBC
	osTLF3_1 << "SELECT t_ca_id, t_exec_name, t_is_cash, t_trade_price, t_qty, TO_VARCHAR(t_dts, 'YYYY-MM-DD HH24:MI:SS.FF6'), t_id, t_tt_id FROM trade WHERE t_s_symb = '" <<
	pIn->symbol << "' AND t_dts >= '" <<
	start_trade_dts << "' AND t_dts <= '" <<
	end_trade_dts << "' ORDER BY t_dts LIMIT " <<
	pIn->max_trades;
...
#elif HANA_ODBC
		osTLF3_2 << "SELECT se_amt, TO_VARCHAR(se_cash_due_date, 'YYYY-MM-DD'), se_cash_type FROM settlement WHERE se_t_id = " <<
#elif PGSQL_ODBC
...
#elif HANA_ODBC
			osTLF3_3 << "SELECT ct_amt, TO_VARCHAR(ct_dts, 'YYYY-MM-DD HH24:MI:SS.FF6'), ct_name FROM cash_transaction WHERE ct_t_id = " <<
#elif PGSQL_ODBC
...
#elif HANA_ODBC
		osTLF3_4 << "SELECT TO_VARCHAR(th_dts, 'YYYY-MM-DD HH24:MI:SS.FF6'), th_st_id FROM trade_history WHERE th_t_id = " <<
	    pOut->trade_info[i].trade_id << " ORDER BY th_dts ASC LIMIT 3";
#elif PGSQL_ODBC
